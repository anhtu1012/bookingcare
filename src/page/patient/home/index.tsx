    ...
    <div className="home">
      ...
      <div className="home-service">
        ...
        <div className="home-service__button-row">
          <div className="colum__main">
            <div className="colum">
              <div className="colum__icon">
                <img
              ...
              <span className="colum__title">Khám Chuyên Khoa</span>
            </div>
            <div className="colum">
              <div className="colum__icon">
                <img
              ...
              <span className="colum__title">Khám Tổng Quát</span>
            </div>
            <div className="colum">
              <div className="colum__icon">
                <img
              ...
              <span className="colum__title">Sức Khỏe Tinh Thần</span>
            </div>
            <div className="colum">
              <div className="colum__icon">
                <img
              ...
              <span className="colum__title">Gói Phẫu Thuật</span>
            </div>
            <div className="colum">
              <div className="colum__icon">
                <img
              ...
              <span className="colum__title">Bài Test Sức Khỏe</span>
            </div>
          </div>
          <div className="colum__main">
            <div className="colum">
              ...
              <span className="colum__title">Khám Từ Xa</span>
            </div>
            <div className="colum">
              <div className="colum__icon">
                <img
              ...
              <span className="colum__title">Xét Nghiệm Y Học</span>
            </div>
            <div className="colum">
              <div className="colum__icon">
                <img
              ...
              <span className="colum__title">Khám Nha Khoa</span>
            </div>
            <div className="colum">
              <div className="colum__icon">
                <img
              ...
              <span className="colum__title">Sống Khỏe Tiểu Đường</span>
            </div>
            <div className="colum">
              <div className="colum__icon">
                <img
